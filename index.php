<!DOCTYPE html>
<!-- saved from url=(0050)http://tympanus.net/Tutorials/FullscreenBookBlock/ -->
<html lang="en" >
<!--class=" js touch cssanimations csstransforms csstransforms3d csstransitions"> -->
				...
				<div id="bb-bookblock" class="bb-bookblock" style="perspective: 2000px;">
					<div class="bb-item" id="item1" style="display: none;">
						<div class="content"><div class="scroller">
								...
								<h4><p>Come on, share that story</p></h4>
								<p>When was the last time you laughed or shed a tear, watching a movie or reading a great novel? Do you remember relating very strongly to a character in a moving story? Ever wondered why the human mind reacts emotionally to a story?</p>
								<p>For several years now, scientists have been trying to study the effect of stories on human neurons. The results are amazing: Tense moments in a story can produce the stress hormone cortisol, while happy endings can create dopamine which makes us optimistic and hopeful. Positive characters or actions in a story also produce oxytocin which leads to empathy and better understanding capabilities.  </p>
					...
					<div class="bb-item" id="item2" style="display: none;">
						<div class="content"><div class="scroller">
								<h2>Why we die</h2>
					...
					<div class="bb-item" id="item3" style="display: none;">
						<div class="content"><div class="scroller">
								<h2>The honeymoon</h2>
					...
					<div class="bb-item" id="item4" style="display: block;">
						<div class="content" style="overflow: hidden; padding: 0px; outline: none; width: 1280px;"><div class="jspContainer" style="width: 1280px; height: 769px;"><div class="jspPane" style="padding: 0px; top: 0px; width: 1280px;"><div class="scroller">
					...
					<div class="bb-item" id="item6" style="display: none;">
						<div class="content"><div class="scroller">
								<h2>Item 6</h2>
								<p>From that excellent work, "Scenes in the Practice of a New York Surgeon,"
								by Dr. E. H. Dixon, I copy, with some abbreviation, the following, which
					...
					<div class="bb-item" id="item7" style="display: none;">
						<div class="content"><div class="scroller">
								<h2>Item 7</h2>
								<p>From that excellent work, "Scenes in the Practice of a New York Surgeon,"
								by Dr. E. H. Dixon, I copy, with some abbreviation, the following, which
